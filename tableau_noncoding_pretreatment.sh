...
# all the different HSP of the same allignment thus share the same evaluebut keep their own bitscore.
...
awk -v query_species="${query_species}" -v subject_species="${subject_species}" -v BLAST_OUT="${BLAST_OUT}" '
